    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=150, unique=True)),
                ('slug', models.SlugField(blank=True, max_length=150, unique=True)),
                ('old_price', models.DecimalField(decimal_places=2, default=Decimal('1000.00'), max_digits=150)),
                ('sale_price', models.DecimalField(decimal_places=2, default=Decimal('1000.00'), max_digits=150)),
                ('available_stock', models.PositiveIntegerField(default=0, validators=[django.core.validators.MaxValueValidator(10000)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('variant_price', models.DecimalField(decimal_places=2, max_digits=150)),
